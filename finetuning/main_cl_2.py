...
model_PATH = "/home/hong/CL/pre-training/models/" + args.dataset + "_" + args.aug1 + "_" + str(args.aug_ratio1) + "_" + args.aug2 + "_" + str(args.aug_ratio2) + "_" + args.model_lr + "_" + str(args.suffix) + "_0.015.pt"
...
# log_PATH = "logs1/" + args.model + "_consis_0.2_" + args.dataset + "_log_" + str(args.semi_split)
