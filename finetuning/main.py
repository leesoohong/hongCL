...
parser.add_argument('--model_lr', type=str, default="0.01")
...
log_PATH = "/home/hong/CL/finetuning/logs1/" + args.model + "_" + args.dataset + "_log_" + str(args.semi_split) + "fold"
if args.model == "cl":
    model_PATH = "/home/hong/CL/pre-training/models/" + args.dataset + "_dropN_0.2_maskN_0.2_" + args.model_epoch + "_" + args.model_lr +"_0.pt"
