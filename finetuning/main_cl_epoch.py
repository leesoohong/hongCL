...
model_PATH = "/home/hong/CL/pre-training/models5/" + args.dataset + "_" + args.aug1 + "_" + str(args.aug_ratio1) + "_" + args.aug2 + "_" + str(args.aug_ratio2) + "_" + args.model_lr + "_" + str(args.suffix) + "_"+str(args.alpha)+"_"+str(args.m_epoch)+".pt"

aa_model_PATH = "/home/hong/CL/pre-training/models2/" + "_autoaugment2_0.2_" + str(100)+ "_" + args.model_lr + "_" + str(args.suffix) + ".pt"


# log_PATH = "logs/" + args.model + "_" + args.dataset + "_" + args.aug1 + "_" + args.aug2 + "_" + str(args.suffix) + "_log_" + str(args.semi_split) ###
log_PATH = "real2/" + args.model + "_" + args.dataset + "_"+str(args.alpha)+"_log_" + str(args.semi_split)+str(args.aug_ratio1)+"_"+str(args.m_epoch)
# log_PATH = "logs1/" + args.model + args.dataset + "_log_" + str(args.semi_split)
...
def run_exp_single_test():
    ...
    run_exp_lib([('NCI1', 'deg+odeg100+ak3+reall', 'ResGCN')])
