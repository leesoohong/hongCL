...
parser.add_argument('--model_epoch', type=str, default="10")
...
model_PATH = "/home/hong/CL/pre-training/model_his/" + args.dataset + "_" + args.aug1 + "_" + str(args.aug_ratio1) + "_" + args.aug2 + "_" + str(args.aug_ratio2) + "_" + args.model_lr + "_" + str(args.suffix) + "_"+str(args.alpha)+"_"+str(args.epochs)+".pt"


# log_PATH = "logs/" + args.model + "_" + args.dataset + "_" + args.aug1 + "_" + args.aug2 + "_" + str(args.suffix) + "_log_" + str(args.semi_split) ###
log_PATH = "log_his/" + args.model + "_" + args.dataset + "_"+str(args.alpha)+"_log_" + str(args.semi_split)+str(args.aug_ratio1)+"_"+str(args.epochs)
