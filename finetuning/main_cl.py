...
model_PATH = "/home/hong/CL/pre-training/models5/" + args.dataset + "_" + args.aug1 + "_" + str(args.aug_ratio1) + "_" + args.aug2 + "_" + str(args.aug_ratio2) + "_" + args.model_lr + "_" + str(args.suffix) + "_"+str(args.alpha)+"_"+str(args.epochs)+".pt"


# log_PATH = "logs/" + args.model + "_" + args.dataset + "_" + args.aug1 + "_" + args.aug2 + "_" + str(args.suffix) + "_log_" + str(args.semi_split) ###
log_PATH = "real2/" + args.model + "_" + args.dataset + "_"+str(args.alpha)+"_log_" + str(args.semi_split)+str(args.aug_ratio1)+"_"+str(args.epochs)
