...
def get_dataset(name, sparse=True, feat_str=True, root=None, aug=None, aug_ratio=None):
    ...
    if 'MNIST' in name or 'CIFAR' in name:
        ...
        dataset = TUDatasetExt(
            ...
            use_node_attr=True, processed_filename="data.pt", aug=aug, aug_ratio=aug_ratio)
