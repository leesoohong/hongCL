...
from train_eval import cross_validation_with_val_set, cross_validation_with_val_set_his, single_train_test
...
def run_exp_lib2(dataset_feat_net_triples,
    ...
    for exp_id, (dataset_name, feat_str, net) in enumerate(
        ...
        controller_train(
                ...
                aug1="dropN", aug_ratio1=0.2,
                aug2="maskN", aug_ratio2=0.2, suffix=0)
...
def run_exp_lib(dataset_feat_net_triples,
    ...
    for exp_id, (dataset_name, feat_str, net) in enumerate(
        ...
        model_func = get_model(net)
        print(dataset)
        cross_validation_with_val_set_his(
                dataset,
                model_func,
                folds=10,
                epochs=args.epoch,
                ...
                aug2=args.aug2, aug_ratio2=args.aug_ratio1, suffix=args.suffix)
...
def run_exp_single_test():
    ...
    run_exp_lib([('NCI1', 'deg+odeg100+ak3+reall', 'ResGFN')])


def run_exp_single_test2():
    print('[INFO] running single test..')
